...
~~~
  > Copying BPMessageCenterLib from `/Users/yiche/Library/Caches/CocoaPods/Pods/External/BPMessageCenterLib/ac0999518905dfaeb4412e75cb70102e` to `Pods/BPMessageCenterLib`
-> Pre-downloading: `BPNewsLib` from `http://gitlab.bitautotech.com/WP/Mobile/IOS/BPNewsLib.git`, tag `0.4.5`
 > Git download
 > Git download
     $ /usr/bin/git clone http://gitlab.bitautotech.com/WP/Mobile/IOS/BPNewsLib.git /var/folders/7w/q65n0jy56nq42f3k0nlfnbm00000gn/T/d20181228-23832-zemqsr --template= --single-branch --depth 1 --branch 0.4.5
...
[!] Error installing BPNewsLib
[!] Failed to download 'BPNewsLib'.
~~~
