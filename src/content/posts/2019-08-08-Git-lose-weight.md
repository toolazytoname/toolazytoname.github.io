---
title: Git工作目录瘦身
date: 2019-08-08T16:19:32+08:00
categories: Git
tags:
  - Git
  - iOS
  ...
  - 自制工具
  - Shell
summary: "给膨胀的 Git 仓库瘦身，清掉大文件和无效历史。"
...
1.  [《使用Cocoapods创建私有podspec》](/ios/2018/06/23/private-podspec/) 
2.  [《使用Cocoapods 踩过的坑》](/ios/2018/07/04/private-podspec-FAQ/) 
3. [《定时取源码执行pod lib lint校验》](/ios/2018/07/13/FDPodBot/) 
4.  [《cocoapods依赖关系导出》](/ios/2018/12/27/cocoapods-graph/) 
5.  [《iOS 组件二进制》](/ios/2019/08/01/cocoapods-binary//) 
6.  [《Git工作目录瘦身》](/git/2019/08/08/Git-lose-weight/) 
